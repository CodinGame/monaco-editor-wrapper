...
const loader = {
  ...
  'namespace.r': async () => (await import(/* webpackChunkName: "language-configuration-namespace.r" */ /* webpackMode: "lazy" */ './languageConfigurations/namespace.r.json')).default,
  'buildignore.r': async () => (await import(/* webpackChunkName: "language-configuration-buildignore.r" */ /* webpackMode: "lazy" */ './languageConfigurations/buildignore.r.json')).default,
  ...
  'jade': async () => (await import(/* webpackChunkName: "language-configuration-jade" */ /* webpackMode: "lazy" */ './languageConfigurations/jade.json')).default,
  'plaintext': async () => (await import(/* webpackChunkName: "language-configuration-plaintext" */ /* webpackMode: "lazy" */ './languageConfigurations/plaintext.json')).default,
  ...
  'go.mod': async () => (await import(/* webpackChunkName: "language-configuration-go.mod" */ /* webpackMode: "lazy" */ './languageConfigurations/go.mod.json')).default,
  'go.work': async () => (await import(/* webpackChunkName: "language-configuration-go.work" */ /* webpackMode: "lazy" */ './languageConfigurations/go.work.json')).default
