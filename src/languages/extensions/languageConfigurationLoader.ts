...
const loader = {
  ...
  'bsv': async () => (await import(/* webpackChunkName: "language-configuration-bsv" */ './languageConfigurations/bsv.json')).default,
  'ucf': async () => (await import(/* webpackChunkName: "language-configuration-ucf" */ './languageConfigurations/ucf.json')).default,
  'sdc': async () => (await import(/* webpackChunkName: "language-configuration-sdc" */ './languageConfigurations/sdc.json')).default,
  'xdc': async () => (await import(/* webpackChunkName: "language-configuration-xdc" */ './languageConfigurations/xdc.json')).default,
