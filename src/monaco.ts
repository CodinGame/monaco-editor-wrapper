...
import {
  ...
  errorHandler,
  createModelReference as vscodeCreateModelReference
...
async function createModelReference(
  resource: monaco.Uri,
  content?: string
...
export { createEditor, createModelReference, registerEditorOpenHandler }
