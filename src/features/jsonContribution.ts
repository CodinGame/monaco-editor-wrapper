...
const schemasById = monaco.extra.Registry.as<monaco.extra.IJSONContributionRegistry>(monaco.extra.JsonContributionExtensions.JSONContribution)
...
// Hack because the commands are filled by a code not run in monaco-editor
{
  ...
  const keybindingsCommandSchema = (schemasById['vscode://schemas/keybindings']!.items as monaco.extra.IJSONSchema).properties!.command.anyOf![0]!
...
monaco.languages.json.jsonDefaults.setDiagnosticsOptions({
  ...
  schemas: [{
    ...
    schema: schemasById['vscode://schemas/settings/resourceLanguage']
  }, {
    uri: 'vscode://schemas/keybindings',
    fileMatch: ['file:///keybindings.json'],
    schema: schemasById['vscode://schemas/keybindings']
  },
  {
